...
if __name__ == "__main__" :
	...
	for index in range(0,len(training_data)):
		print str(index+1)+"\t"+str(instance_fold_mapping[str(training_data[index])])+"\t"+str(instance_output_mapping[str(training_data[index])][0])+"\t"+str(instance_output_mapping[str(training_data[index])][1])+"\t"+str(instance_output_mapping[str(training_data[index])][2])
